...
rightAudioElement.setAttribute('src', 'sound/RewardSo-Mark_E_B-8078_hifi.mp3');
...
$(".help-btn").on('click',function(){
  ...
  $('#playSound').click(function(){
   ...
   $('#pauseSound').click(function(){
      rightAudioElement.volume = 0;
      wrongAudioElement.volume = 0;
...
function checkAnswer(draggable, event) {
  ...
  if (dropCard == currentCard) {
    ...
    rightAudioElement.play();  
     ...
     $(".ans-panel span").html('Oops! Think again!');
  }
  setTimeout(function(){
