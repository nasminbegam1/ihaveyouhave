...
@section('content')
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Update Card</div>
                </div>
                ...
                <div class="col-lg-12">
                        <div class="panel panel-pink">
                            ...
                            <div class="panel-body ">
                                {!! Form::open(['route'=>['admin_card_edit',$details->id],'class'=>"form-validate",'files'=>true]) !!}
                                        ...
                                        <div class="form-group"><label class="col-md-3 control-label" for="inputUsername"> Answer<span class="require">*</span></label>
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon"><i class="fa fa-font"></i>{!!  Form::text('answer',$details->answer,['class'=>'form-control required']) !!}</div>
                                            </div>
                                        </div><br/><br/><br/>
                                        ...
                                        <div class="form-group"><label class="col-md-3 control-label" for="inputUsername"> Photo<span class="require">*</span></label>
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon">{!!  Form::file('image',['class'=>'form-control','accept'=>'image/*']) !!}</div>
                                            </div>
                                        </div><br/><br/><br/>
